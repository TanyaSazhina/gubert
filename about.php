            ...
            <div class="hello__container container">
                <div class="hello__content">
                    <h1 class="hello__title title">
                        Привет, я <span class="blue">Александр Губерт</span>
                    </h1>
                    <div class="hello__post">
                        UI/UX дизайнер и Web разработчик
                    </div>
                ...
                <a href="#about" class="hello__arrow arrow arrow__down">
            ...
            <div class="about__container container">
                ...
                <div class="about__content">
                    <div class="about__text">
                        <p>Я — квалифицированный веб-разработчик с опытом работы более 10 лет и перфекционист, получаю
                            удовольствие от продуктов высшего качества, поэтому отдаюсь своей работе полностью, уделяя
                            большое внимание деталям. Делаю свои работы такими, чтобы ими можно было гордиться.</p>
                        <p>Закончил Сибирский государственный автомобильно-дорожный университет, факультет
                            Информационные системы в управлении, специальность Автоматизированные системы обработки
                            информации и управления.</p>
                        <p>В данный момент являюсь руководителем веб-студии "AG group", партнером рекламного агентства
                            "LEGA IT Marketing" и сооснователем проекта "СЕОподвиг".</p>
                    </div>
                    <div class="about__img">
                        <picture>
                            <source srcset="img/my-photo.webp" type="image/webp"><img class="photo" src="img/my-photo.jpg" alt="photo">
                        </picture>
                    </div>
                </div>
            </div>
